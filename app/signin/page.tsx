...
export default function SignInPage() {
  ...
  useEffect(() => {
    if (!isSupabaseConfigured && googleBtnRef.current && !session) {
      initGoogleSignIn(
        googleBtnRef.current,
        async (user: GoogleUserInfo) => {
        ...
        // Google script failed to load — non-critical
      });
    }
  }, [session, signInWithGoogle, router]);
          ...
          <div className="rounded-2xl border border-border bg-card p-8">
            ...
            <div className="mt-6 space-y-3">
              {isSupabaseConfigured ? (
                // Supabase mode — use button click
                <Button
                  type="button"
                  variant="outline"
                  className="w-full"
                ...
                // Mock auth mode — render Google GIS button
